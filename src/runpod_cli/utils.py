...
def get_setup_root(runpodcli_path: str, volume_mount_path: str) -> Tuple[str, str]:
    return "setup_root.sh", textwrap.dedent(
        ...
        # Set PATH and environment for both interactive and non-interactive shells
        echo "export HF_HOME=/workspace/hf_home/" >> /home/user/.bashrc
        echo 'export PATH="$HOME/.local/bin:$PATH"' >> /home/user/.bashrc
        echo "export HF_HOME=/workspace/hf_home/" >> /home/user/.profile
...
def get_setup_user(runpodcli_path: str, git_email: str, git_name: str, git_repo_url: str = "") -> Tuple[str, str]:
    return "setup_user.sh", textwrap.dedent(
        ...
        if [ -n "GIT_REPO_URL" ]; then
            ...
            cd /workspace
            git clone "GIT_REPO_URL" || echo "Warning: Failed to clone repository"
        fi
